...
LIGHTTPD_DEPENDENCIES = host-pkgconf logrotate
LIGHTTPD_CONF_OPT = \
...
define LIGHTTPD_INSTALL_CONFIG
	...
	[ -f $(TARGET_DIR)/etc/lighttpd/modules.conf ] || \
		$(INSTALL) -D -m 755 package/lighttpd/modules.conf \
...
define LIGHTTPD_INSTALL_LOG
        # install logrotate rule
        cp package/lighttpd/lighttpdLog.conf $(TARGET_DIR)/etc/logrotate.d/
endef

LIGHTTPD_POST_INSTALL_TARGET_HOOKS += LIGHTTPD_INSTALL_CONFIG
LIGHTTPD_POST_INSTALL_TARGET_HOOKS += LIGHTTPD_INSTALL_LOG
